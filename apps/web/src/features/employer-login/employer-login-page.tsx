      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 100, background: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(12px)', borderBottom: '1px solid #f1f5f9' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px', height: 60, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <a href="/employer/register" style={{ fontSize: 14, fontWeight: 600, color: '#6366f1', textDecoration: 'none' }}>Register</a>
          </div>
        </div>
      </header>
      ...
      <div style={{ minHeight: 'calc(100vh - 60px)', display: 'flex', background: 'linear-gradient(160deg, #f8f7ff 0%, #f0f4ff 50%, #faf5ff 100%)' }}>
        ...
        <div style={{ flex: 1, display: 'none', alignItems: 'center', justifyContent: 'center', padding: 48, background: 'linear-gradient(135deg, #6366f1, #8b5cf6)' }} className="left-panel">
          <div style={{ maxWidth: 360, color: '#fff' }}>
            <h2 style={{ fontSize: 32, fontWeight: 800, margin: '0 0 16px', letterSpacing: '-0.5px' }}>Find your perfect candidate</h2>
            <p style={{ fontSize: 16, opacity: 0.8, lineHeight: 1.7 }}>Intelligent matching connects you with the right talent based on your job requirements.</p>
          </div>
        </div>
        ...
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
          <div style={{ width: '100%', maxWidth: 420 }}>
            ...
            <p style={{ fontSize: 15, color: '#64748b', margin: '0 0 32px' }}>Sign in to manage your job postings and find candidates</p>
            ...
            <div style={{ background: '#fff', borderRadius: 24, border: '1.5px solid #e0e7ff', padding: '36px 32px' }}>
              ...
              <p style={{ textAlign: 'center', fontSize: 13, color: '#6b7280', margin: 0 }}>
                ...
                <a href="/employer/register" style={{ color: '#6366f1', fontWeight: 700, textDecoration: 'none' }}>
                  Register free →
                </a>
              </p>
            ...
            <p style={{ textAlign: 'center', fontSize: 12, color: '#9ca3af', marginTop: 20 }}>
              ✓ Free to post · ✓ Intelligent matching · ✓ Top-10 candidate recommendations
            </p>
