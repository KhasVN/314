      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 100, background: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(12px)', borderBottom: '1px solid #f1f5f9' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 24px', height: 60, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <a href="/home" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
            ...
            <span style={{ fontWeight: 800, fontSize: 18, color: '#111827', letterSpacing: '-0.3px' }}>Linkedout</span>
          </a>
          <nav style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            ...
            <a href="/candidate/login" style={{ fontSize: 14, fontWeight: 600, color: '#6366f1', background: '#ede9fe', padding: '8px 18px', borderRadius: 10, textDecoration: 'none', marginLeft: 8 }}>Candidate sign in</a>
            <a href="/employer/login" className="ml-2 rounded-[10px] bg-[#2557a7] px-[18px] py-2 text-sm font-semibold text-white no-underline hover:bg-[#164081]">
              Employer sign in
            </a>
          </nav>
      ...
      <section style={{ padding: '80px 24px', background: '#fff' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20, maxWidth: 760, margin: '0 auto' }}>
            ...
            <div className="squircle-card overflow-hidden border-[#d4d2d0] bg-gradient-to-br from-[#eef4ff]/80 to-white">
              <div className="h-1 bg-[#2557a7]" />
              <div className="px-8 py-9">
                <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl border border-[#d4d2d0] bg-[#eef4ff]">
                  <svg width="26" height="26" fill="none" viewBox="0 0 24 24" stroke="#2557a7" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                  </svg>
                </div>
                <h3 className="mb-2 text-[22px] font-extrabold text-[#2d2d2d]">I&apos;m an employer</h3>
                <p className="mb-2 text-sm leading-relaxed text-[#595959]">
                  Find the right talent for your company using intelligent matching.
                </p>
                <ul className="mb-7 list-none p-0">
                  {['Get Top-10 matched candidates', 'Post job descriptions', 'Filter by skills and education', 'Manage applications easily'].map((f) => (
                    <li key={f} className="flex items-center gap-2 py-1 text-[13px] text-[#595959]">
                      <span className="font-bold text-[#2557a7]">✓</span> {f}
                    </li>
                  ))}
                </ul>
                <a href="/employer/register" className="mb-3 block rounded-xl bg-[#2557a7] px-6 py-3 text-center text-sm font-bold text-white no-underline hover:bg-[#164081]">
                  Register as employer
                </a>
                <p className="m-0 text-center text-[13px] text-[#767676]">
                  Have an account?{' '}
                  <a href="/employer/login" className="font-semibold text-[#2557a7] no-underline hover:underline">
                    Employer sign in
                  </a>
                </p>
              </div>
      ...
      <section style={{ padding: '80px 24px', background: '#fff' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <h2 style={{ fontSize: 32, fontWeight: 800, color: '#0f172a', margin: '0 0 10px', letterSpacing: '-0.5px' }}>Why Linkedout?</h2>
      ...
      <section style={{ padding: '0 24px 80px', background: '#f8fafc', textAlign: 'center' }}>
        <div style={{ maxWidth: 600, margin: '0 auto', paddingTop: 80 }}>
          ...
          <p style={{ fontSize: 16, color: '#64748b', margin: '0 0 32px', lineHeight: 1.7 }}>
            Join Linkedout today. Create your profile in minutes and let our system find the perfect job for you.
          </p>
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="/candidate/register" style={{ background: 'linear-gradient(135deg, #6366f1, #8b5cf6)', color: '#fff', padding: '14px 32px', borderRadius: 12, fontWeight: 700, fontSize: 15, textDecoration: 'none' }}>
              Register as candidate →
            </a>
            <a href="/employer/register" className="rounded-xl border border-[#d4d2d0] bg-white px-8 py-3.5 text-[15px] font-bold text-[#2d2d2d] no-underline hover:bg-[#f3f2f1]">
              Register as employer
            </a>
          </div>
        </div>
      ...
      <footer style={{ background: '#0f172a', padding: '40px 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontWeight: 700, fontSize: 16, color: '#fff' }}>Linkedout</span>
          ...
          <p style={{ fontSize: 12, color: '#475569', margin: 0 }}>© 2025 Linkedout · Intelligent Linkedouting Platform</p>
        </div>
      </footer>
